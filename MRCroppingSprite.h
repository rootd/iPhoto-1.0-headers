...
@interface MRCroppingSprite : _ACAccountTypeIdentifierTwitter
{
...
+ (void)renderImage:(id)fp8 inContext:(id)fp12 atPosition:(struct CGPoint)fp16 andSize:(struct CGSize)fp24 withReferenceAspectRatio:(float)fp32 andJustifications:(struct CGPoint)fp36;
...
+ (void)renderImage:(id)fp8 inContext:(id)fp12 atPosition:(struct CGPoint)fp16 andSize:(struct CGSize)fp24 zRotation:(float)fp32;
+ (void)renderImage:(id)fp8 inContext:(id)fp12 atPosition:(struct CGPoint)fp16 andSize:(struct CGSize)fp24;
+ (void)renderDumbImage:(id)fp8 inContext:(id)fp12 atPosition:(struct CGPoint)fp16 andSize:(struct CGSize)fp24 zRotation:(float)fp32;
...
- (void)renderImageOuter:(id)fp8 inContext:(id)fp12 atPosition:(struct CGPoint)fp16 andSize:(struct CGSize)fp24 zRotation:(float)fp32;
- (void)renderImageMiddle:(id)fp8 inContext:(id)fp12 atPosition:(struct CGPoint)fp16 andSize:(struct CGSize)fp24 zRotation:(float)fp32;
- (void)renderImageInner:(id)fp8 inContext:(id)fp12 atPosition:(struct CGPoint)fp16 andSize:(struct CGSize)fp24 zRotation:(float)fp32;
